...
This first chapter is an introduction to the report and afterwards the purpose, problem statement and the outline of the rest of the report.

It is very easy to play a game today so what we want to do is making a new sort of game, where the user have to script a file describing a behaviour of a regiment, or several regiments. The user can then challenge his friend, with this script and his friend can then script his own file and let them compete against each other. This should both be a fun way to learn a basic scripting language and a fun way of playing a game. 

Related work:
Our project is similar to the Crobots which also is a programming game \cite{crobots} and the Robocode \cite{robocode} which have the same ideas of their programming language as we have with the WAR language, it shall we simple to use.
The Robocode states that one can make a script in a few minutes or use several days on perfecting the script. 
