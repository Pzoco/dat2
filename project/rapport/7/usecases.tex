...
\end{lstlisting}
	...
	\subsection{Screenshots from use case 1}
		\begin{figure}
			\includegraphics[scale=0.5]{rapport/7/figures/case1-1.png}
			\caption{The battle begins}
		\end{figure}
		\begin{figure}
			\includegraphics[scale=0.5]{rapport/7/figures/case1-2.png}
			\caption{The Warriors chase the archers}
		\end{figure}
		\begin{figure}
			\includegraphics[scale=0.5]{rapport/7/figures/case1-3.png}
			\caption{Team 2 won!}
		\end{figure}