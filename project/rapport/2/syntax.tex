\section{Syntax}
	...
	\subsubsection{BNF}
		...
		\begin{center}
			\begin{tabular}{ l l l }
				...
				Hero-Block		   &	::=	 & {\bf Hero} Block-Name {\bf \{ } UnitStat Behaviour-Block \bf{\} }\\
				...
				UnitStat-Name	   &	::=	 & {\bf Size =} Integer-Literal{\bf ;} $\mid$ {\bf Type} = AttackType{\bf ;} $\mid$ \\
								   ...
								   &	     & {\bf Damage =} Integer-Literal{\bf ;} $\mid$ {\bf Movement = }Integer-Literal{\bf ;} \\								   &		 & $\mid$ {\bf Position(} Integer-Literal {\bf ,} Integer-Literal {\bf );}\\
	...
	\subsubsection{EBNF}
		...
		These are the non-terminals that changed from the BNF to the EBNF.
		\begin{center}
			\begin{tabular}{ l l l }
				...
				Parameters		   &	::=	 & (Parameters{\bf ,})* UnitStat-Type Operator Integer-Literal\\
				Single-Command     &	::=  & (Control-Structure $\mid$ UnitStat) ($\epsilon \mid$ Single-Command)      \\		
				UnitFunction	   &	::=	 & ({\bf Attack(} $\mid$ {\bf MoveTowards(} $\mid${\bf MoveAway(}) Identifier {\bf );} \\
